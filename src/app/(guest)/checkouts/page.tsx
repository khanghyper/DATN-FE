        ...
        <div className="w-[90%]">
          ...
          <div className="content bg-white border rounded p-4 mt-3">
            <section className="headerCart w-full h-[55px]  mt-5 flex items-center gap-4 text-[14px] bg-white text-[#000000]">
              ...
              <div className="w-[173px] h-[20px] text-center ">Đơn giá</div>
              <div className="w-[168px] h-[20px] text-center ">Số lượng</div>
              <div className="w-[114px] h-[20px] text-center ">Thành tiền</div>
            </section>
            <div className="title w-full h[55px] flex items-center gap-4">
              <div className="border p-1 rounded-[10px]  bg-red-400 text-white">
                yêu thích
              </div>
