    ...
    <div className="w-1/2 bg-gray-100 p-12 flex flex-col justify-center">
      <div className="max-w-md w-full mx-auto">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 text-white py-2 px-4 flex items-center justify-center gap-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
          >
            {loading && (
              <div role="status">
