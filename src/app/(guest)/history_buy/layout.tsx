...
const HistoryBuyLayout = async ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className='w-content h-auto '>
      ...
      <div className='body-page w-full flex justify-between gap-4 mt-4'>
        <div className='bg-white left-body w-[275px] h-[318px] border shadow rounded-lg flex flex-col items-center justify-center pt-4 '>
...
export default HistoryBuyLayout;