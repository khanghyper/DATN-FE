                ...
                <div className="w-full">
                  <div className="w-full h-[180px] relative">
                    <div className="w-full mb-2">
                      <span className="text-[20px] font-bold">{productDetail[0].name}</span>
                    </div>
                    <div className="w-full">
                      <span className="text-[14px] font-normal">Thương hiệu: {productDetail[0].brand ?? 'chưa có thương hiệu'}</span>
                    </div>
                    <div className="w-full">
                      <span className="text-[24px] font-bold text-red-500">{productDetail[0].show_price}đ</span>
                    </div>
                    <div className="w-full">
                    ...
                    <div className="absolute bottom-0 w-full left-0">
                      <div className="w-full flex gap-3 items-center">
                        ...
                        <div className="flex gap-1 items-center">
                          ...
                          <span className="text-[14px] text-gray-400">{productDetail[0].sold_count} lượt mua</span>
                        </div>
                      </div>
                    </div>
                  </div>
